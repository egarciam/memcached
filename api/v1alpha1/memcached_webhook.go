...
//+kubebuilder:webhook:path=/mutate-cache-egarciam-github-com-v1alpha1-memcached,mutating=true,failurePolicy=fail,sideEffects=None,groups=cache.egarciam.github.com,resources=memcacheds,verbs=create;update,versions=v1alpha1,name=mmemcached.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-cache-egarciam-github-com-v1alpha1-memcached,mutating=false,failurePolicy=fail,sideEffects=None,groups=cache.egarciam.github.com,resources=memcacheds,verbs=create;update,versions=v1alpha1,name=vmemcached.kb.io,admissionReviewVersions=v1
